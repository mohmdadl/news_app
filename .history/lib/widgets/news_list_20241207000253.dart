...
class NewsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverList(
        ...
        childCount: NewsService(dio:Dio()).articels_model.length, // Ensure the number of items corresponds to the list size
      (context, index) => NewsWidget(articleModel: [index]),
    ));
  }
}
